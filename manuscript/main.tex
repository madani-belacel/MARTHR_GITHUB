...
Figure~\ref{fig:baseline} compares MARTHR with the MRHOF ETX-based baseline across lossless, lossy, and attack scenarios. MARTHR's context-aware weighting produces higher multi-criteria scores while the MRHOF baseline optimizes only for ETX without trust or energy awareness.
